...
import * as MyOfferAction from './MyOfferAction';
...
class MyOfferDetailScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
const styles = StyleSheet.create({
  ...
  containerAdjustment: {
    height: Dimensions.get('window').height - 130 - 30 - 85,
  ...
  itemContainer: {
    ...
    backgroundColor: '#FFF',
    borderRadius: 4,
    height: Dimensions.get('window').height - 130 - 30 - 80 - 60
  },
  itemContainerWithBoarder: {
    ...
    height: Dimensions.get('window').height - 130 - 30 - 80 - 20 - 40 - 70
  },
  itemContainerInner: {
    flexDirection: 'row',
    paddingTop: 10,
...
const mapDispatchToProps = dispatch => {
  return {
    MyOfferAction: bindActionCreators(MyOfferAction, dispatch)
